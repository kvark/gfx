...
impl hal::Instance<crate::Backend> for Instance {
    fn create(_: &str, _: u32) -> Result<Self, hal::UnsupportedBackend> {
        //TODO: https://github.com/timothee-haudebourg/khronos-egl/issues/3
        let no_display = unsafe { egl::Display::from_ptr(ptr::null_mut()) };
        let client_extensions =
            egl::query_string(no_display, egl::EXTENSIONS).map_err(|_| hal::UnsupportedBackend)?;
        ...
        let display = {
            ...
            let x11_display = unsafe { x11::xlib::XOpenDisplay(ptr::null()) };
        ...
        let display_extensions = egl::query_string(display, egl::EXTENSIONS).unwrap();
        log::info!(
...
impl w::PresentationSurface<crate::Backend> for Surface {
    ...
    unsafe fn acquire_image(
        ...
        let texture = native::ImageView::Renderbuffer(sc.renderbuffer);
        Ok((texture, None))
    }
}
